  ...
  <div class="kyligence-zen-ml-toolkit">
    <div class="upload-box" v-if="!dowloadFileUrl" :loading="isUploading">
      <el-upload
        ...
        <div class="el-upload__tip" slot="tip"><a href="https://github.com/Kyligence/zen-ml-toolkit/releases">Ver: 0.1.3</a>, only [.tds, .twb, .sql] file supported, we help you export calculated fields or measures into an Excel spreadsheet. 5MB maximum file size.</div>
      </el-upload>
